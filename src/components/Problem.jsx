        ...
        <div className="bento-grid">
          ...
          <div className="bento-card col-8 scroll-reveal-card tilt-glow-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p>
                ...
                из одного человека. Из них **42.6%** — это люди старше трудоспособного возраста. Миллионы 
          ...
          <div className="bento-card col-4 scroll-reveal-card tilt-glow-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p>
                Уровень приверженности терапии у пожилых пациентов составляет всего **52.5%**. Почти половина 
          ...
          <div className="bento-card col-4 scroll-reveal-card tilt-glow-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p>
                ...
                на **15%**. Схемы усложняются, а самоконтроль с возрастом снижается.
              </p>
            </div>
          ...
          <div className="bento-card col-8 scroll-reveal-card tilt-glow-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p>
                Люди старше трудоспособного возраста составляют более **24%** населения. Звонки раз в день 
